...
def get_bcm(
    ...
    """
    Constructs and returns a BayesianCompartmentalModel for Ca Mau TB transmission.

    Args:
        params: Fixed parameters for the model.
        covid_effects: COVID-19 effects on detection/contact rates.
        clearance_mode: If True, adds an IGRA clearance flow (late_latent → cleared).
        implement_act3: If True, adds ACT3 trial stratification (trial/control/other arms).
        future_acf_scenarios: Optional ACF scenario dicts for post-trial projections.

    Returns:
        BayesianCompartmentalModel ready for calibration or scenario analysis.
    """
    params = params or {}
